...
if (isset($_POST["sliderekle"])) {
    ...
    if ($_FILES["resim"]["size"] > 0) {
        ...
        $sliderEkle = $baglan->prepare("INSERT INTO slider SET 
        ...
        if ($ekle) {
            header("Location:slider2.php?durum=ok");
        } else {
            header("Location:slider2.php?durum=no");
        }
    } else {
        header("Location:slider2.php?durum=eksik");
    }
}
...
if (isset($_POST["sliderduzenle"])) {
    if ($_FILES["resim"]["size"] > 0) {
        ...
        if ($update) {
            ...
            header("Location:duzenle.php?sayfa=slider&durum=ok&id=$id");
        } else {
            header("Location:duzenle.php?sayfa=slider&durum=no&id=$id");
        }
    } else {
...
if (isset($_POST["slidersil"])) {
    ...
    $slidersil = $baglan->prepare("DELETE FROM slider where id=$id");
    ...
    if ($delete) {
        unlink("../resimlerSite/slider/$resim");
        header("Location:slider2.php?durum=ok");
    } else {
        header("Location:slider2.php?durum=no");
    }
...
if (isset($_POST["icerikekle"])) {
    ...
    if ($_FILES["resim"]["size"] > 0) {
        ...
        $icerikEkle = $baglan->prepare("INSERT INTO icerik SET 
        ...
        header("Location:icerik.php?durum=eksik");
    }
}
...
if (isset($_POST["icerikduzenle"])) {
    if ($_FILES["resim"]["size"] > 0) {
        ...
        $icerikduzenle = $baglan->prepare("UPDATE icerik SET  
        resim=?,
        baslik=?,
        aciklama=?,
        sira=?
        ...
        if ($update) {
            ...
            header("Location:duzenle.php?sayfa=icerik&durum=ok&id=$id");
        } else {
            header("Location:duzenle.php?sayfa=icerik&durum=no&id=$id");
        }
    } else {
...
if (isset($_POST["iceriksil"])) {
    ...
    $iceriksil = $baglan->prepare("DELETE FROM icerik where id=$id");
    $delete = $iceriksil->execute();
